  ...
  return (
    <section className="relative py-20 lg:py-[150px] border-b border-[#362E49] text-white overflow-hidden text-center bg-[linear-gradient(180deg,#854CFF8A_0%,#05010f_100%)]">
      <div className="container relative z-10 mx-auto px-4">
        ...
        <div className="flex flex-row items-center justify-center sm:gap-7.5 gap-3 mt-10">
          <ButtonSwipUp className="bg-white sm:text-base text-sm w-fit text-black hover:text-white" url={"/contact-us"}>
            Get a Quote
