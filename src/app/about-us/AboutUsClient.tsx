          ...
          <div className=" flex flex-col lg:flex-row items-center gap-16">            
            <div className="flex-1 space-y-10">
              <div className="space-y-6">
                ...
                <ContentSwipUp>
                  We focus on the needs of our clients to provide 100% satisfaction. Our expertise spans UI/UX design, custom WordPress themes, enterprise Laravel systems, high-speed Node.js backends, React/Next.js architectures, and native/hybrid iOS and Android mobile applications.
                </ContentSwipUp>
              </div>
            </div>
